...
class Planeswalker4AbilityTemplateCardView: CardTemplateView {
  ...
  @IBOutlet weak var ability4rulesText: NSTextField!
  ...
  @IBOutlet weak var ability4rulesTextNoCost: NSTextField!
  ...
  @IBOutlet weak var abilityCost4Positive: NSImageView!
  @IBOutlet weak var abilityCost4Zero: NSImageView!
  @IBOutlet weak var abilityCost4Negative: NSImageView!
  ...
  @IBOutlet weak var abilityCost4: NSTextField!
  ...
  @IBOutlet weak var ability4colonPositive: NSTextField!
  @IBOutlet weak var ability4colonZero: NSTextField!
  @IBOutlet weak var ability4colonNegative: NSTextField!
  ...
  func initSubviews() {
    Bundle(for: type(of: self))
      .loadNibNamed(NSNib.Name(rawValue: "Planeswalker4AbilityTemplateCardView"), owner: self, topLevelObjects: nil)
  ...
  override func updateBackgroundTexture(card: Card) {
    switch card.colors {
    case 3...5:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Multicolored Background Texture"))
      
    case 2 where !card.isHybrid:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Multicolored Background Texture"))
      
    case 2 where card.isWhite && card.isBlue:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid White Blue Background Texture"))
      
    case 2 where card.isWhite && card.isBlack:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid White Black Background Texture"))
      
    case 2 where card.isBlue && card.isBlack:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Blue Black Background Texture"))
      
    case 2 where card.isBlue && card.isRed:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Blue Red Background Texture"))
      
    case 2 where card.isBlack && card.isRed:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Black Red Background Texture"))
      
    case 2 where card.isBlack && card.isGreen:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Black Green Background Texture"))
      
    case 2 where card.isRed && card.isGreen:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Red Green Background Texture"))
      
    case 2 where card.isRed && card.isWhite:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Red White Background Texture"))
      
    case 2 where card.isGreen && card.isWhite:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Green White Background Texture"))
      
    case 2 where card.isGreen && card.isBlue:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Green Blue Background Texture"))
      
    case 1 where card.isWhite:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker White Background Texture"))
      
    case 1 where card.isBlue:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Blue Background Texture"))
      
    case 1 where card.isBlack:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Black Background Texture"))
      
    case 1 where card.isRed:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Red Background Texture"))
      
    case 1 where card.isGreen:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Green Background Texture"))
      
    default:
      backgroundTexture.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Colorless Background Texture"))
    }
  }
  ...
  override func updateTitlebarAndTypeLine(card: Card) {
    ...
    case 2...5 where !card.isHybrid:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Multicolored Titlebar & Type Line"))
      
    case 2:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Titlebar & Type Line"))
      
    case 1 where card.isWhite:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker White Titlebar & Type Line"))
      
    case 1 where card.isBlue:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Blue Titlebar & Type Line"))
      
    case 1 where card.isBlack:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Black Titlebar & Type Line"))
      
    case 1 where card.isRed:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Red Titlebar & Type Line"))
      
    case 1 where card.isGreen:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Green Titlebar & Type Line"))
      
    default:
      titlebarAndTypeLine.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Colorless Titlebar & Type Line"))
    }
  }
  ...
  override func updateFrameBorder(card: Card) {
    switch card.colors {
    case 3...5:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Multicolored Card Frame"))
      
    case 2 where card.isWhite && card.isBlue:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid White Blue Card Frame"))
      
    case 2 where card.isWhite && card.isBlack:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid White Black Card Frame"))
      
    case 2 where card.isBlue && card.isBlack:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Blue Black Card Frame"))
      
    case 2 where card.isBlue && card.isRed:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Blue Red Card Frame"))
      
    case 2 where card.isBlack && card.isRed:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Black Red Card Frame"))
      
    case 2 where card.isBlack && card.isGreen:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Black Green Card Frame"))
      
    case 2 where card.isRed && card.isGreen:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Red Green Card Frame"))
      
    case 2 where card.isRed && card.isWhite:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Red White Card Frame"))
      
    case 2 where card.isGreen && card.isWhite:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Green White Card Frame"))
      
    case 2 where card.isGreen && card.isBlue:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Hybrid Green Blue Card Frame"))
      
    case 1 where card.isWhite:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker White Card Frame"))
      
    case 1 where card.isBlue:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Blue Card Frame"))
      
    case 1 where card.isBlack:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Black Card Frame"))
      
    case 1 where card.isRed:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Red Card Frame"))
      
    case 1 where card.isGreen:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Green Card Frame"))
      
    default:
      frameBorder.image = NSImage(named: NSImage.Name(rawValue: "4-Ability Planeswalker Colorless Card Frame"))
  ...
  func rulesTextFontSize(card: Card) -> CGFloat {
    ...
    switch card.planeswalkerAbility1.characters.count +
           ...
           card.planeswalkerAbility4.characters.count {
  ...
  override func updatePlaneswalkerInfo(card: Card) {
    ...
    abilityCost4.stringValue = card.planeswalkerAbility4Cost
    ...
    let ability4attributedString = NSMutableAttributedString(string: card.planeswalkerAbility4, attributes: attributes)
    ...
    parseBodyText(string: ability4attributedString, size: fontSize, align: .left)
    ...
    replaceCardName(string: ability4attributedString.mutableString, with: card.name)
    ...
    ability4rulesText.attributedStringValue = ability4attributedString
  ...
  func updatePlaneswakerVisibility(card: Card) {
    ...
    if card.planeswalkerAbility4Cost != "" {
      let idx = card.planeswalkerAbility4Cost.characters.startIndex
      switch card.planeswalkerAbility4Cost.characters[idx] {
      case Character("+"):
        abilityCost4.isHidden = false
        abilityCost4Positive.isHidden = false
        abilityCost4Zero.isHidden = true
        abilityCost4Negative.isHidden = true
        ability4colonPositive.isHidden = false
        ability4colonZero.isHidden = true
        ability4colonNegative.isHidden = true
        ability4rulesText.isHidden = false
        ability4rulesTextNoCost.isHidden = true
      case Character("0"):
        abilityCost4.isHidden = false
        abilityCost4Positive.isHidden = true
        abilityCost4Zero.isHidden = false
        abilityCost4Negative.isHidden = true
        ability4colonPositive.isHidden = true
        ability4colonZero.isHidden = false
        ability4colonNegative.isHidden = true
        ability4rulesText.isHidden = false
        ability4rulesTextNoCost.isHidden = true
      case Character("-"):
        ...
        abilityCost4Positive.isHidden = true
        abilityCost4Zero.isHidden = true
        abilityCost4Negative.isHidden = false
        ability4colonPositive.isHidden = true
        ability4colonZero.isHidden = true
        ability4colonNegative.isHidden = false
        ability4rulesText.isHidden = false
        ability4rulesTextNoCost.isHidden = true
      default:
        abilityCost4.isHidden = true
        abilityCost4Positive.isHidden = true
        abilityCost4Zero.isHidden = true
        abilityCost4Negative.isHidden = true
        ability4colonPositive.isHidden = true
        ability4colonZero.isHidden = true
        ability4colonNegative.isHidden = true
        ability4rulesText.isHidden = true
        ability4rulesTextNoCost.isHidden = false
      }
    } else {
      abilityCost4.isHidden = true
      abilityCost4Positive.isHidden = true
